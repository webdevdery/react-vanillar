...
import { setTICover  } from '../../actions/policy'

import brand from '../../assets/img/Page 60, 62 1.png'
import thunbsup from '../../assets/img/thunbsup.png'

const AddTICover = (props) => {
    ...
    const proposer_has_TI_cover = useSelector(state => state.basic_detail.proposer_has_TI_cover)
    const name = useSelector(state => state.ti_cover.name_of_insure)
    const rider = useSelector(state => state.ti_cover.rider_or_standalone)
    const acc = useSelector(state => state.ti_cover.acc_or_additional_benefit)
    const cv_amount = useSelector(state => state.ti_cover.coverage_amount)
    const [name_of_insure, setName] = useState(name)
    const [rider_or_standalone, setRider] = useState(rider)
    const [acc_or_additional_benefit, setBenifit] = useState(acc)
    const [coverage_amount, setAmount] = useState(cv_amount)
    const handleNextButton = () => {
        dispatch(setTICover({
            proposer_has_TI_cover: proposer_has_TI_cover,
            name_of_insure: name_of_insure,
            rider_or_standalone: rider_or_standalone,
            acc_or_additional_benefit: acc_or_additional_benefit,
            coverage_amount: coverage_amount
        }))
        dispatch(increment());
        history.push('/ci-cover');
    };
    const handlePrevButton = () => {
        dispatch(decrement());
        history.push('/ti-cover');
    };
    return (
    <>
                                    ...
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <SelectField 
                                                ...
                                                name="ti_insurer_name"
                                                value={ rider_or_standalone }
                                                label="Policy type"
                                    ...
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <InputField 
                                                ...
                                                class="form-control padd5"
                                                name="name_of_insure"
                                                value={ name_of_insure }
                                                label="Name of the Insurer"
                                                placeholder="Sum assured"
                                                onChange={e => setName(e.target.value)}
                                                required="required"
                                                feedback="Please provide a valid Name of the Insurer"
                                            />
                                        </div>
                                    </div>                                                  
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <SelectField 
                                                class="form-control padd5"
                                                name="ti_loss_of_employment"
                                                value={ acc_or_additional_benefit }
                                                label="Additional benefits available in case of loss of employment due to CI"
                                                onChange={e => setBenifit(e.target.value)}
                                                options={[
                                                    {value: 'Accelerating base benefit', label: 'Accelerating base benefit'},
                                                    {value: 'Additional Fixed Benefit', label: 'Additional Fixed Benefit'},
                                                ]}
...
AddTICover.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddTICover;
