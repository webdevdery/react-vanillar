...
import { setCICover  } from '../../actions/policy'
...
const AddCICover = () => {
    ...
    const proposer_has_CI_cover = useSelector(state => state.basic_detail.proposer_has_CI_cover)
    const name = useSelector(state => state.ci_cover.name_of_insurer)
    const sum = useSelector(state => state.ci_cover.sum_assured_available)
    const benifit = useSelector(state => state.ci_cover.additional_benefits)
    const amount = useSelector(state => state.ci_cover.additional_benefits_amount)
    ...
    const handleNextButton = () => {
        ...
        dispatch(setCICover({
            proposer_has_CI_cover: proposer_has_CI_cover,
            name_of_insure: name,
...
AddCICover.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddCICover;
