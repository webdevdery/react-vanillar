...
import { setMotorVehicle  } from '../../actions/policy'
import brand from '../../assets/img/Page 41, 43 1.png'
import thunbsup from '../../assets/img/thunbsup.png'


const AddMotorVehicle = () => {
    ...
    const vehicle_type = useSelector(state => state.motor_insurance.vehicle_type)
    const vehicle_age = useSelector(state => state.motor_insurance.vehicle_age)
    const vehicle_new_actual_cost = useSelector(state => state.motor_insurance.vehicle_new_actual_cost)

    const [type, setType] = useState(vehicle_type)
    const [age, setAge] = useState(vehicle_age)
    const [actual_cost, setCost] = useState(vehicle_new_actual_cost)
    const handleNextButton = () => {
        dispatch(setMotorVehicle({
            vehicle_type: type,
            vehicle_age: age,
            vehicle_new_actual_cost: actual_cost,
        }))
        dispatch(increment());
                                    ...
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <SelectField 
                                                ...
                                                required="required"
                                                feedback="Please select a valid Vehicle Type"
                                            />
                                        </div>
                                    </div>                                                                                                 
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <SelectField 
                                                ...
                                                placeholder="select cot of new vehicle"
                                                required="required"
                                                feedback="Please select a valid Cot of new vehicle"
                                            />
                                        </div>
                                    </div>                                                                                                
                                    <div className="col-md-6">
                                        <div className="inputField my-4">
                                            <SelectField 
                                                ...
                                                placeholder="select age of vehicle"
                                                required="required"
                                                feedback="Please select a valid Age of Vehicle"
                                            />
                                        </div>
                                    </div>                                                          
                                </div>
...
AddMotorVehicle.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddMotorVehicle;
