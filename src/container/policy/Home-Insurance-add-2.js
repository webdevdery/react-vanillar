                        ...
                        <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                            <div className="formField">
                                <div className="col-12">
                                    ...
                                    <h4 className="text-left mb-2">Together with Home Insurance, have you bought?</h4>
                                </div>
                                    ...
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                name="income_growth"
                                                value={ accomodation }
                                                label="Cover for additional rent for alternate accommodation"
                                                onChange={ e => setAccomodation(e.target.value)}
                                                placeholder="select the cover for additional rent"
                                                options={[
                                                    {value: '10', label: '10'},
                                                    {value: '20', label: '20'},
                                                    {value: '30', label: '30'},
                                                ...
                                                required="required"
                                                feedback="Please select a valid value"
                                            />
                                        </div>
                                    </div>                                                    
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                name="income_invest"
                                                // value={ phone_number }
                                                label="Cover for Jewellery & Valuables"
                                                ...
                                                placeholder="select the cover for Jewellery & Valuables"
                                                required="required"
                                                feedback="Please select a valid"
                                            />
                                        </div>
                                    </div>                                                  
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                placeholder="select the cover against Terrorism"
                                                required="required"
                                                feedback="Please select a valid"
                                            />
                                        </div>
...
AddHomeInsurance2.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddHomeInsurance2;
