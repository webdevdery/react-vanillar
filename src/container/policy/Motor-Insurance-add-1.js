...
const AddMotorInsurance1 = (props) => {
    ...
    const motor_insurance_type = useSelector(state => state.motor_insurance.motor_insurance_type)
    const [ type, setType ] = useState(motor_insurance_type);
    const handleNextButton = () => {
        ...
        dispatch(increment());
        history.push('/motor-insurance-add-2');
    };
                                    ...
                                    <div className="col-md-6">
                                        <div className="my-5">
                                            <SelectField 
                                                ...
                                                placeholder="select the type of policy bought"
                                                required="required"
                                                feedback="Please select a valid Type of policy bought"
                                            />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="my-4">
                                            <SelectField 
                                                ...
                                                placeholder="select IDV of Vehicle"
                                                required="required"
                                                feedback="Please select a valid IDV_vehicle"
                                            />
                                        </div>
                                    </div>
                                </div>
...
AddMotorInsurance1.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddMotorInsurance1;
