...
const AddHomeInsurance1 = (props) => {
    ...
    const handleNextButton = () => {
        if(property_value === '' || property_value === null || property_value === undefined) {
            $('form').addClass('was-validated');
            return false;
        }
        if(content_value === '' || content_value === null || content_value === undefined) {
            $('form').addClass('was-validated');
            return false;
        }
        dispatch(increment());
        history.push('/home-insurance-add-2');
    };
                                    ...
                                    <div className="col-md-6">
                                        <div className="my-5">
                                            <SelectField 
                                                ...
                                                label="Property value declared in insurance policy"
                                                ...
                                                required="required"
                                                feedback="Please select a valid Property value"
                                            />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="my-4">
                                            <SelectField 
                                                ...
                                                name="income_invest"
                                                value={ content_value }
                                                label="Value of content declared"
                                                options={[
                                                    {value: '10', label: '10'},
                                                    {value: '20', label: '20'},
                                                    {value: '30', label: '30'},
                                                ...
                                                placeholder="select Value of content declared"
                                                required="required"
                                                feedback="Please select a valid value of content declared"
                                            />
                                        </div>
                                    </div>
                                </div>
...
AddHomeInsurance1.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddHomeInsurance1;
