...
import brand from '../../assets/img/Page 31,33 1.png'
import thunbsup from '../../assets/img/thunbsup.png'


const AddPermanentCover2 = (props) => {
    ...
    const [conrent, setConrent] = useState();
                                    ...
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                required="required"
                                                feedback="Please select a valid Property Type"
                                            />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                placeholder="select the market value of
                                                    property"
                                                required="required"
                                                feedback="Please select a valid Market Value"
                                            />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                placeholder="select the re construction cost"
                                                required="required"
                                                feedback="Please select a valid Reconstruction Cost"
                                            />
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="inputField my-3">
                                            <SelectField 
                                                ...
                                                name="income_ex_growth"
                                                value={ conrent }
                                                label="Value of conrent in property"
                                                onChange={ e => setConrent(e.target.value) }
                                                options={[
                                                    {value: '10', label: '10'},
                                                    {value: '20', label: '20'},
                                                    {value: '30', label: '30'},
                                                ]}
                                                placeholder="Select the value of corent in property"
                                                required="required"
                                                feedback="Please select a valid Reconstruction Cost"
                                            />
                                        </div>
...
AddPermanentCover2.propTypes = {
  name: PropTypes.string,
  nextPage: PropTypes.string,
  prevPage: PropTypes.string
};

export default AddPermanentCover2;
