...
import { setHIStatus  } from '../../actions/policy'
...
const HealthInsurance = (props) => {
    ...
    dispatch(setHIStatus(health_insurance))
    dispatch(increment());
    if (health_insurance === '0') {
        dispatch(increment());
        history.push('/ti-cover');
    } else {
        history.push('/health-insurance-add');
    }
    };
                            ...
                            <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                                <div className="formField">
                                    <div className="col-12">
                                        ...
                                        <h4 className="text-left mb-2">Have you bought health insurance policy?</h4>
                                    </div>
                                    <div className="col-md-10 d-flex flex-wrap">
                                        <div className="radioOption kids">
                                            <RadioButton 
                                                radio_name="health_insurance"
                                                radio_value="1"
