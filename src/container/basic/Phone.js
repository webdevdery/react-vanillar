...
import brand from '../../assets/img/Page 1 1.png'
import increment, { decrement, init_current  } from '../../actions'
import setPhoneNumber, { getProposalID } from '../../actions/basic'

const Phone = () => {
    let history = useHistory();
    const dispatch = useDispatch()
    const [phone_number, setPhone] = useState('');
    useEffect(() => dispatch(init_current()));
    const handleNextButton = () => {
        ...
        dispatch(getProposalID(phone_number))
        dispatch(increment());
        history.push('/name');
    };
            ...
            <div className="form-card">
                <div className="row">
                    ...
                    <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                        ...
                        <h4>Before starting out, Would you mind telling your number.</h4>
                        <InputField 
                            type="tel"
