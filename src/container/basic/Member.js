...
import { setMemberStatus  } from '../../actions/basic'
import brand from '../../assets/img/Page 19 1.png'
...
const Member = (props) => {
    ...
    const has_member = useSelector(state => state.spouse_detail.proposer_requires_coverage_health_extra_members)
    const [member_status, SetMember] = useState('0');
    const handleNextButton = () => {
    dispatch(setMemberStatus(member_status))
    dispatch(increment());
    if(member_status === '0') {
        dispatch(increment());
        history.push('/family');
                    ...
                    <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                        <div className="formField">
                            <div className="col-12">
                                ...
                                <p className="pcolor mb-5">If you want to include more than 1 member, click on add more to enter details for another member.</p>
                            </div>
