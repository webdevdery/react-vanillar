...
import { setWork, setChildStatus } from '../../actions/basic'

import brand from '../../assets/img/Page 14 1.png'
...
const WorkDetail = (props) => {
    ...
    const proposer_occupation_nature = useSelector(state => state.spouse_detail.proposer_occupation_nature)
    const proposer_annual_income = useSelector(state => state.spouse_detail.spouse_annual_income)
    const proposer_expected_increase_annual_income = useSelector(state => state.spouse_detail.spouse_expected_increase_annual_income)
    const proposer_has_children = useSelector(state => state.spouse_detail.proposer_has_children)
    ...
    const [has_children, setHasChildren] = useState(proposer_has_children)
    ...
    if(expected_increase === '' || expected_increase === null || expected_increase === undefined) {
        $('form').addClass('was-validated');
        return false;
    }
    if(has_children === '' || has_children === null || has_children === undefined) {
        $('form').addClass('was-validated');
        return false;
    }
    dispatch(setWork({
    ...
    dispatch(setChildStatus(has_children))
    dispatch(increment());
    if(has_children === '1')
        history.push('/child-detail');
    else {
        dispatch(increment());
        history.push('/member');   }
    };
                    ...
                    <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                        <div className="formField">
                            <div className="col-12">
                                ...
                                <h4 className="text-left mb-2">Work Details</h4>
                            ...
                            <div className="col-md-10 p-0 d-flex flex-wrap">
                                <div className="col-12 col-sm-6 mb-4">
                                    <SelectField 
                                        ...
                                        required="required"
                                        feedback="Please select a Occupation"
                                    />
                                </div>
                                <div className="col-12 col-sm-6 mb-4">
                                    <InputField 
                            ...
                            <div className="col-12 mt-4 mb-5">
                                <h5 className="font-bold mb-2">Do you have kids?</h5>

                                <div className="radioOption kids">
                                    <RadioButton 
                                        radio_name="child_radio"
                                        radio_value="1"
...
WorkDetail.propTypes = {
  ...
  annual_income: PropTypes.number,
  expected_increase: PropTypes.number,
  has_children: PropTypes.string
};
