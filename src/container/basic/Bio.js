...
import { setBio } from '../../actions/basic'

import brand from '../../assets/img/Page 3 1.png'
...
const Bio = () => {
    ...
    const proposer_dob = useSelector(state => state.basic_detail.proposer_dob); 
    const proposer_age = useSelector(state => state.basic_detail.proposer_age); 
    const proposer_height = useSelector(state => state.basic_detail.proposer_height); 
    const proposer_bmi = useSelector(state => state.basic_detail.proposer_bmi); 
                  ...
                  <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                      <div className="formField">
                          <div className="col-12">
                              ...
                              <h4 className="text-left mb-2">Welcome , { userName }</h4>
                              <p className="pcolor mb-5">Let’s have some more info about you.</p>
                          </div>
                          <div className="col-md-10 p-0 d-flex flex-wrap">
                              ...
                              <div className="col-12 col-sm-6 mb-4">
                                <InputField 
                                  ...
                                  name="age"
                                  value={ age }
                                  label="Age until when you expect to work"
