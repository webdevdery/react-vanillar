...
import { setFamily  } from '../../actions/basic'
import brand from '../../assets/img/Page 23 1.png'
...
const Family = () => {
    ...
    const city_of_residence = useSelector(state => state.family_detail.city_of_residence)
    const avg_weekly_physical_activity = useSelector(state => state.family_detail.avg_weekly_physical_activity)
    const level_base_health_coverage_required = useSelector(state => state.family_detail.level_base_health_coverage_required)
    const alcohol_smoking_habits = useSelector(state => state.family_detail.alcohol_smoking_habits)
    const disease_history_heart_diseases = useSelector(state => state.family_detail.disease_history_heart_diseases)
    const disease_history_high_bp = useSelector(state => state.family_detail.disease_history_high_bp)
    const disease_history_stroke = useSelector(state => state.family_detail.disease_history_stroke)
    const disease_history_cancer = useSelector(state => state.family_detail.disease_history_cancer)
    const disease_history_others = useSelector(state => state.family_detail.disease_history_others)

    const [car, setCar] = useState('0');
    const [property, setProperty] = useState('0');
    const [residence, setResidence] = useState(city_of_residence);
    const [physical_activity, setActivity] = useState(avg_weekly_physical_activity);
    const [habit, setHabit] = useState(alcohol_smoking_habits);
    const [base_health, setBaseHealth] = useState(level_base_health_coverage_required);
    const [heart_diseases, setHeartDiseases] = useState(disease_history_heart_diseases);
    const [high_bp, setHighBp] = useState(disease_history_high_bp);
    const [stroke, setStroke] = useState(disease_history_stroke);
    const [cancer, setCancer] = useState(disease_history_cancer);
    const [others, setOthers] = useState(disease_history_others);

    const handleNextButton = () => {
        dispatch(setFamily({
            city_of_residence: residence,
            avg_weekly_physical_activity: physical_activity,
            alcohol_smoking_habits: residence,
            level_base_health_coverage_required: base_health,
            disease_history_heart_diseases: heart_diseases,
            disease_history_high_bp: high_bp,
            disease_history_stroke: stroke,
            disease_history_cancer: cancer,
            disease_history_others: others,
        }))
        dispatch(increment());
                        ...
                        <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                            <div className="formField">
                                <div className="col-12">
                                    ...
                                    <h4 className="text-left mb-2">Family Details</h4>
                                    <p className="pcolor mb-5">Provide some basic details about your family.</p>
                                </div>

                                <div className="col-12 col-sm-12 col-md-10 p-0 mb-4">
                                    <div className="col-sm-6">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid Residence"
                                        />
                                    </div>
                                </div>

                                <div className="col-md-10 mt-5">
                                    <h4 className="mb-1">Do you own any car ?</h4>
                                    <div className="radioOption kids">
                                        <RadioButton 
                                            radio_name="car_radio"
                                            radio_value="1"
                                ...
                                <div className="col-md-10 mt-5">
                                    <h4 className="mb-1">Do you own any residential property ?</h4>
                                    <div className="radioOption kids">
                                        <RadioButton 
                                            radio_name="property_radio"
                                            radio_value="1"
                                ...
                                <div className="col-md-10 p-0 d-flex flex-wrap my-5">
                                    <h5 className="w-100 col-12">Life style choices of Family:</h5>
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            class="form-control padd5"
                                            name="physical_activity"
                                            value={ physical_activity }
                                            label="Average level of weekly physical activity"
                                    ...
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            name="alcohol"
                                            value={ habit }
                                            label="Alcohol and / or Smoking habits"
                                ...
                                <div className="col-md-10 p-0 d-flex flex-wrap">
                                    <h5 className="w-100 col-12">Family history of diseases</h5>
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            class="form-control padd5"
                                            name="heart_diseases"
                                            ...
                                            onChange={e => setHeartDiseases(e.target.value)}
                                            options={[
                                                {value: '10', label: '10'},
                                                {value: '20', label: '20'},
                                                {value: '30', label: '30'},
                                            ...
                                            required="required"
                                            feedback="Please select a valid Heart diseases"
                                        />
                                    </div>
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid Diabetes"
                                        />
                                    </div>                                                    
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid High BP"
                                        />
                                    </div>                                                  
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid Stroke"
                                        />
                                    </div>                                                  
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid Cancer"
                                        />
                                    </div>                                                  
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            required="required"
                                            feedback="Please select a valid Other_disease"
                                        />
                                    </div>                                                  
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            class="form-control padd5"
                                            name="other_disease_name"
                                            // value={ phone_number }
                                            label="Please state the other diseases"
                                            ...
                                            required="required"
                                            feedback="Please select a valid Other_disease Name"
                                        />
                                    </div>                                                   
                                    <div className="col-12 col-sm-6 mb-4">
                                        <SelectField 
                                            ...
                                            name="health_cover"
                                            value={ base_health }
                                            label="Level of Base Health Coverage Required"
                                            ...
                                            required="required"
                                            feedback="Please select a valid Level of Base Health Coverage "
                                        />
                                    </div>
                                </div>
...
Family.propTypes = {
  ...
  base_health: PropTypes.string,
  heart_diseases: PropTypes.string,
  high_bp: PropTypes.string,
  stroke: PropTypes.string,
  cancer: PropTypes.string,
