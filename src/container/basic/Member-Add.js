...
import { setMember  } from '../../actions/basic'
import brand from '../../assets/img/Page 21 1.png'
import thunbsup from '../../assets/img/thunbsup.png'
import addmember from '../../assets/img/addChild.png'

function load_script() {
    $('.btn-remove, .memberNumber, .memberNumber, .btn-remove1').hide();
    ...
    $(".btn-copy1").on('click', function(){
        ...
        //var i = $(this).closest('.memberDetail').find('.sequence').attr('data-id');
...
const AddMember = () => {
    ...
    const m_dob = useSelector(state => state.member_detail.member_dob);
    const m_bmi = useSelector(state => state.member_detail.member_bmi);
    const [member_dob, setMemberDob] = useState(m_dob);
    const [member_bmi, setMemberBmi] = useState(m_bmi);
    const handleNextButton = () => {
    if(member_dob === '' || member_dob === null || member_dob === undefined) {
        $('form').addClass('was-validated');
        return false;
    }
    if(member_bmi === '' || member_bmi === null || member_bmi === undefined) {
        $('form').addClass('was-validated');
        return false;
    }
    dispatch(setMember({
            ...
            <span className="active li_prev">
                <div className="d-flex flex-wrap align-items-center">
                    ...
                    <div className="listName">
                        ...
                        <p className="mb-0">member Details</p>
                    </div>
                </div>
            </span>
                    ...
                    <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                        <div className="formField">
                            <div className="col-12">
                                ...
                                <h4 className="text-left mb-2">Do you want to include other members for Health Insurance Coverage?</h4>
                                <p className="pcolor mb-5">If you want to include more than 1 member, increase the number of member.</p>
                            </div>

                            <div className="addMember">
                                <div className="col-md-10 p-0 d-flex flex-wrap">
                                    <span className="btn-remove1">
                                        - Delete Entry
                                    </span>

                                    <h5 className="mb-3 memberNumber">Member <span className="sequence1">1</span> Details</h5>
                                    <div className="col-12 col-sm-6 mb-4">
                                        <InputField 
                                            type="date"
                                            class="form-control padd5 health_coverage"
                                            name="member_DOB"
                                            value={ member_dob }
                                            label="Member 1 DOB"
                                            ...
                                            required="required"
                                            feedback="Please provide a valid Member Date"
                                        />
                                    </div>
                                    <div className="col-12 col-sm-6 mb-4">
                                        <InputField 
                                            ...
                                            name="member_bmi"
                                            value={ member_bmi }
                                            label="BMI Score of Member"
                                            placeholder="Your BMI score"
                                            onChange={ e => setMemberBmi( e.target.value ) }
                                            required="required"
                                            feedback="Please provide a valid BMI Score of Member"
                                        />
                                        <small>Don't know your BMI, <Link to="/">click here to calculate</Link></small>
                                    </div>
                                </div>
                                <p className="col-12">
                                    <span className="btn-copy1">
                                        <img src={ addmember } alt="Add" /> Add more member
                                    </span>
                                </p>
                            </div>
                        </div>
