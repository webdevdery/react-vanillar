...
import { setPersonalInfo } from '../../actions/basic'

import brand from '../../assets/img/Page 12 1.png'
...
const PersonalInfo = (props) => {
    ...
    const proposer_dob = useSelector(state => state.spouse_detail.proposer_dob); 
    const proposer_age = useSelector(state => state.spouse_detail.proposer_age); 
    const proposer_height = useSelector(state => state.spouse_detail.proposer_height); 
    const proposer_bmi = useSelector(state => state.spouse_detail.proposer_bmi); 
    const [birthday, setBirthday] = useState(proposer_dob);
    const [age, setAge] = useState(proposer_age);
    const [height, setHeight] = useState(proposer_height);
    const [bmi, setBmi] = useState(proposer_bmi);
    ...
    dispatch(setPersonalInfo({
        proposer_dob: birthday,
        proposer_age: age,
        proposer_height: height,
        proposer_bmi: bmi
    }));
    dispatch(increment());
                ...
                <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                    <div className="formField">
                        <div className="col-12">
                            ...
                            <h4 className="text-left mb-2">Personal Info</h4>
                            <p className="pcolor mb-5">Let’s have some more info about your spouse.</p>
                        </div>
                        <div className="col-md-10 p-0 d-flex flex-wrap">
                            ...
                            <div className="col-12 col-sm-6 mb-4">
                                ...
                                value={ height }
                                label="Height"
                                placeholder="For ex.: 5’11, 6’2, 4’9"
                                onChange={e => setHeight(e.target.value)}
                                required="required"
                                feedback="Please provide a valid Height"
                                />
                            </div>
                            <div className="col-12 col-sm-6 mb-4">
                                <SelectField 
                                ...
                                name="age"
                                value={ age }
                                label="Age until when your spouse expect to work"
                                ...
                                feedback="Please select a valid age"
                                />
                            </div>
                            <div className="col-12 col-sm-6 mb-4">
                                <InputField 
                                ...
                                required="required"
                                feedback="Please provide a valid BMI"
                                />
