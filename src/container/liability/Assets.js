...
const Assets = (props) => {
    ...
    const [assets, setAssetsStatus] = useState('0')
                            ...
                            <div className="col-12 col-sm-12 col-md-8 offset-md-4">
                                <div className="formField">
                                    <div className="col-12">
                                        ...
                                        <h4 className="text-left mb-2">Would you like to assess your efficiency of retirement planning right now?</h4>
                                    </div>
                                    <div className="col-md-10 d-flex flex-wrap">
                                        <div className="radioOption kids">
                                            <RadioButton 
                                                ...
                                                radio_value="1"
                                                onChange={e => setAssetsStatus(e.target.value)}
                                                label="Yes"
                                            />
                                            <RadioButton 
                                                radio_name="insurance_radio"
